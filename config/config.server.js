...
module.exports = {
  ...
  // proxyURL: APIURL,
  app: {
    coustomServiceURL: JSON.stringify('http://kf1.learnsaas.com/chat/chatClient/chatbox.jsp?companyID=920677&configID=70323&jid=2218668569&info=userId%3D1%26name%3D'),
    ENV: JSON.stringify('production'),
    APIURL: JSON.stringify(APIURL),
    // app版本
