...
class RechargeOnlineConfirm extends React.PureComponent {
            ...
            <div className={styles.rechargeDetailContainer}>
                <div className={styles.rechargeDetailBankContainer}>
                    <div className={styles.rechargeDetailSubTitle}>
                      ...
                      <div>{this.props.rechargeInfo && this.props.rechargeInfo.get('rechargeBankName')}</div>
                    </div>
                </div>
...
export default connect(mapStateToProps)(RechargeOnlineConfirm);
